...
xgb = XGBRegressor(random_state=42, verbosity=0, tree_method="hist", callbacks=[es])
...
param_sampler = list(ParameterSampler(param_dist, n_iter=20, random_state=42))
...
final_model = XGBRegressor(**best_params, random_state=42, verbosity=0, tree_method="hist")
final_model.fit(X, y)
model = final_model
